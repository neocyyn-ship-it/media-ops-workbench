...
function seedDatabase(db: Database.Database) {
  ...
  const transaction = db.transaction(() => {
    ...
    const weeklyEngagementSamples = [
      {
        ...
        note: "确认本周 3 个选题方向和拍摄优先级。",
        reference_links: JSON.stringify([
          "https://www.xiaohongshu.com/explore/66f000000000000000000001",
        ]),
        status: "PENDING",
        remark: "会后同步主播与摄影。",
      },
      ...
      },
      {
        ...
        contact_name: "仓库阿泽",
        contact_role: "COLLEAGUE",
        note: "确认西装套装和单鞋尺码是否齐全。",
        reference_links: JSON.stringify([
          "https://www.xiaohongshu.com/explore/66f000000000000000000002",
        ]),
        status: "PENDING",
        remark: "缺码要立刻调货。",
      },
      {
        ...
        contact_name: "主播小七",
        contact_role: "HOST",
        note: "围绕显瘦、提气色、预算区间组织口播。",
        reference_links: JSON.stringify([
          "https://www.xiaohongshu.com/explore/66f000000000000000000003",
        ]),
        status: "PENDING",
        remark: "优先确认开场 30 秒。",
      },
    ...
    weeklyEngagementSamples.forEach((item) =>
